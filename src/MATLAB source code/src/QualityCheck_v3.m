...
for k = Start:End   
        ...
        for i = 1:len
            ...
            PCC = [PCC;pcc]; % Conc atenates the intraPCC results
            %---------------------------------------------
    ...
    intername = [out_path_1 ,'New_Overall_Inter_Recluster2_',Resolution,'.csv'];
    intraname = [out_path_1 ,'New_Overall_Intra_Recluster2_',Resolution,'.csv'];
    diffname = [out_path_1 ,'New_Overall_Diff_Recluster2_',Resolution,'.csv'];
    pccname = [out_path_1 ,'New_Overall_pcc_Recluster2_',Resolution,'.csv'];
    ...
    %----------------------------------------------------------------------
    f= max(Mean_diff);
    readme=strcat(out_path_1,'Readme_Recluster2',name,'.txt');
